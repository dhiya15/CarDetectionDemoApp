  ...
  private void requestPermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
     /* if (shouldShowRequestPermissionRationale(PERMISSION_STORAGE)) {
      ...
      requestPermissions(new String[] {PERMISSION_STORAGE}, 225);
      if (shouldShowRequestPermissionRationale(PERMISSION_STORAGE2)) {
        Toast.makeText(
                CameraActivity.this,
                "Storage permission is required for this demo",
                Toast.LENGTH_LONG)
      ...
      requestPermissions(new String[] {PERMISSION_STORAGE2}, 226);
      if (shouldShowRequestPermissionRationale(PERMISSION_STORAGE3)) {
        Toast.makeText(
                CameraActivity.this,
                "Storage permission is required for this demo",
                Toast.LENGTH_LONG)
      ...
      requestPermissions(new String[] {PERMISSION_STORAGE3}, 227);*/
